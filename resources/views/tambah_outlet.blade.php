                ...
                <form action="{{ url('outlet/store') }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" placeholder="Nama Outlet" name="nama_outlet">
                        </div>
                        <div class="col">
                    ...
                    <div class="form-row mt-4">
                        <div class="col">
                            ...
                            <textarea class="form-control" cols="30" rows="10" aria-label="With textarea" name="alamat_outlet"></textarea>
                        </div>
                    </div>
