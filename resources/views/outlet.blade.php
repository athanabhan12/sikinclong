                                ...
                                <div class="">
                                    <div class="row align-items-start">
                                        <div class="col" style="margin-right: 10px;">
                                            <a href="{{ url('/outlet/create') }}" class="btn btn-success mb-3"><i
                                            ...
                                            <tbody>
                                                @foreach ($outlet as $datas)
                                                    <tr>
                                                        ...
                                                        <td>{{ $datas->nama_outlet}}</td>
                                                        <td>{{ $datas->alamat_outlet }}</td>
                                                        <td>{{ $datas->no_telp_outlet }}</td>
                                                        <td style="text-align: center;">
                                                            <a href="{{ url('outlet/edit-outlet') }}/{{ $datas->id }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ url('outlet/hapus') }}/{{ $datas->id }}"
