            ...
            <div class="page-inner">
                ...
                <form action="{{ url('pelanggan/store') }}" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            <h3 class="ml-2" for="nama">Umur</h3>
                    ...
                    <div class="form-row mt-5">
                        <div class="col">
                            <h3 class="ml-2" for="tgl_register">Tanggal Register</h3>
                            <input type="date" name="tgl_register" class="form-control" id="Tanggal Register"
                    ...
                    <div class="form-row mt-3">
                        <div class="col">
                            ...
                            <textarea class="form-control" cols="10" rows="10" aria-label="With textarea" name="alamat"
