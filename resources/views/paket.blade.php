                            ...
                            <div class="card-header">
                                <div class="" style="margin-right: 1%">
                                    <div class="row align-items-start">
                                        <div class="col">
                                            <a href="{{ url('/paket/create') }}" class="btn btn-success mb-3 ml-4"><i
                                            ...
                                            <tbody>
                                                @foreach ($paket as $pakets)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">{{ $pakets->nama_paket }}</td>
                                                        <td style="text-align: center;">{{ $pakets->jenis_paket }}</td>
                                                        <td style="text-align: center;">Rp.{{ $pakets->harga }}</td>
                                                        <td style="text-align: center;">
                                                            <a href="{{ url('paket/edit-paket') }}/{{ $pakets->id }}"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a href="{{ url('paket/hapus') }}/{{ $pakets->id }}"
